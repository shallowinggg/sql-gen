...
public abstract class SystemPropertyUtils {
    ...
    private static final PropertyPlaceholderHelper STRICT_HELPER =
            new PropertyPlaceholderHelper(PLACEHOLDER_PREFIX, PLACEHOLDER_SUFFIX, VALUE_SEPARATOR, false);

    private static final PropertyPlaceholderHelper NON_STRICT_HELPER =
    ...
    public static String resolvePlaceholders(String text, boolean ignoreUnresolvablePlaceholders) {
        ...
        PropertyPlaceholderHelper helper = (ignoreUnresolvablePlaceholders ? NON_STRICT_HELPER : STRICT_HELPER);
        ...
        public String resolvePlaceholder(String placeholderName) {
            try {
                ...
                if (LOG.isErrorEnabled()) {
                    LOG.error("Could not resolve placeholder '" + placeholderName + "' in [" +
