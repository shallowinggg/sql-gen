...
public class JdbcTypeJavaClassMappings {
    private static final Log log = LogFactory.getLog(JdbcTypeJavaClassMappings.class);
    ...
    private static ConcurrentHashMap<Class<?>, Integer> buildJavaClassToJdbcTypeCodeMappings() {
        final ConcurrentHashMap<Class<?>, Integer> workMap = new ConcurrentHashMap<>(64);
    ...
    private static ConcurrentHashMap<Integer, Class<?>> buildJdbcTypeCodeToJavaClassMappings() {
        final ConcurrentHashMap<Integer, Class<?>> workMap = new ConcurrentHashMap<>(64);
